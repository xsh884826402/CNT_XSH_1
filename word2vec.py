...
from ZhongWenPaiXu import Sort_by_Pinyin
import os
import pickle
...
class Word2Vec_xsh:
    ...
    def build_dictionary(self, model):
        ...
        print("vocab_size:",self.window,len(indexword))
...
if __name__ =="__main__":
    word2vec_xsh= Word2Vec_xsh('./data/bingli_exp_result', './cidian_data15_size3_sorted.pkl', 128, 3)
